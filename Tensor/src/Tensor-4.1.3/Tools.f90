...
!****************************************************************************
	...
	interface operator(+)
		...
		module procedure add_as
		module procedure add_ad
		module procedure add_ac
		module procedure add_az
		module procedure add_al
		module procedure add_ia
		module procedure add_sa
		module procedure add_da
		module procedure add_ca
		module procedure add_za
		module procedure add_la
...
! cha.sub.['c','g']='def'
	...
	interface assignment(=)
		...
		module procedure char2arrayi
		module procedure char2arrays
		module procedure char2arrayd
		module procedure char2arrayc
		module procedure char2arrayz
		module procedure char2arrayl
		module procedure array2chari
		module procedure array2chars
		module procedure array2chard
		module procedure array2charc
		module procedure array2charz
		module procedure array2charl
		module procedure logi2arrayi
		module procedure logi2arrays
		module procedure logi2arrayd
		module procedure logi2arrayc
		module procedure logi2arrayz
		module procedure array2logii
		module procedure array2logis
		module procedure array2logid
		module procedure array2logic
		module procedure array2logiz
	end interface	
...
#include "Tools_include/add.f90"

#include "Tools_include/assignment.f90"
...
!maxindex are [max_s1,max_s2,..,max_sn]
	...
	logical function inde_counter1(inde,minindex,maxindex,delta)result(inde_counter)
		...
		if(delta.gt.1)then
			call writemess('ERROR inde_counter1, DO NOT finsihed',-1)
			call error_stop
		end if
		return
	end function
