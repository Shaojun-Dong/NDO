...
contains
	...
	function getlenOfQuanNum(QN)
		integer::getlenOfQuanNum
		class(QuanNum),intent(in) :: QN
		getlenOfQuanNum=QN%lenOfQuanNum
		return
	end function
	function getQuanNumRule(QN)
		integer::getQuanNumRule
		class(QuanNum),intent(in) :: QN
		getQuanNumRule=QN%Rule
		return
	end function
	function getQuanNumArrow(QN)
		integer::getQuanNumArrow
		class(QuanNum),intent(in) :: QN
		getQuanNumArrow=QN%FermiArrow
		return
	end function

	function getMaxQN(QN)
		real*4::getMaxQN
		class(QuanNum),intent(in) :: QN
